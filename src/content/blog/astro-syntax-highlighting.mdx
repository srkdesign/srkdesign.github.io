---
title: "Как подключить подсветку синтаксиса в блоге на Astro"
...
tags:
  [
    "подсветка синтаксиса в Astro",
    "подключение подсветки синтаксиса в блоге",
    "Astro подсветка кода",
    "подсветка синтаксиса для блога",
    "настройка подсветки синтаксиса Astro",
    "добавить подсветку кода в Astro",
    "настройка подсветки кода",
    "Astro блог подсветка синтаксиса",
    "примеры подсветки синтаксиса в блоге",
  ]
isDraft: false
---
